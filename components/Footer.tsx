      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-12">
           ...
           <div className="col-span-1">
             <h4 className="text-gray-900 dark:text-white font-bold mb-4 text-sm uppercase tracking-wider">Services</h4>
           ...
           <div className="col-span-1">
             <h4 className="text-gray-900 dark:text-white font-bold mb-4 text-sm uppercase tracking-wider">Company</h4>
             <ul className="text-gray-500 dark:text-gray-500 text-xs space-y-2">
               <li>
           ...
           <div className="col-span-1">
             <h4 className="text-gray-900 dark:text-white font-bold mb-4 text-sm uppercase tracking-wider">Resources</h4>
             <ul className="text-gray-500 dark:text-gray-500 text-xs space-y-2">
               {/* Removed Onisaki Selects */}
             </ul>
             
             <h4 className="text-gray-900 dark:text-white font-bold mt-8 mb-4 text-sm uppercase tracking-wider">Office</h4>
