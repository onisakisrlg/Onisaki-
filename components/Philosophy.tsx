      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col xl:flex-row-reverse items-center gap-8 md:gap-16 xl:gap-24">
          ...
          <div className="w-full xl:w-2/5 space-y-6 md:space-y-8">
            ...
            <Reveal delay={0.2}>
              <h2 
                className="text-3xl md:text-6xl font-serif text-gray-900 dark:text-white leading-tight transition-colors duration-500"
            ...
            <Reveal delay={0.8}>
              <div className="flex flex-wrap gap-3 md:gap-4 mt-4 md:mt-8">
                 <div className="px-6 py-2 md:px-8 md:py-3 bg-black/5 dark:bg-white/5 border border-oni-cyan/30 rounded-full text-[10px] md:text-sm text-gray-800 dark:text-white tracking-wider shadow-[0_0_15px_rgba(0,240,255,0.1)] transition-colors duration-500 hover:bg-oni-cyan/10">{t('vision.tag1')}</div>
                 <div className="px-6 py-2 md:px-8 md:py-3 bg-black/5 dark:bg-white/5 border border-oni-magenta/30 rounded-full text-[10px] md:text-sm text-gray-800 dark:text-white tracking-wider shadow-[0_0_15px_rgba(255,0,170,0.1)] transition-colors duration-500 hover:bg-oni-magenta/10">{t('vision.tag2')}</div>
                 <div className="px-6 py-2 md:px-8 md:py-3 bg-black/5 dark:bg-white/5 border border-oni-purple/30 rounded-full text-[10px] md:text-sm text-gray-800 dark:text-white tracking-wider shadow-[0_0_15px_rgba(189,0,255,0.1)] transition-colors duration-500 hover:bg-oni-purple/10">{t('vision.tag3')}</div>
              </div>
            </Reveal>
          </div>
        </div>
